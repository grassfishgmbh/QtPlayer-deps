...
LIBUSB_TARGET="$LIBUSB_DIR/buildspace/libusb-$LIBUSB_VERSION"
...
ZLIB_TARGET="$ZLIB_DIR/buildspace/zlib-$ZLIB_VERSION"
...
CURL_TARGET="$CURL_DIR/buildspace/curl-$CURL_VERSION"
