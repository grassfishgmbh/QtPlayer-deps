...
ISO_ADDITIONAL_PKGS='openssh-server libxss1 lm-sensors pulseaudio pavucontrol libsigc++-2.0-0v5 libgtkmm-3.0-1v5 ubuntu-restricted-extras gstreamer1.0-vaapi i965-va-driver sqlite3 libxvidcore4 gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-ugly gstreamer1.0-plugins-bad gstreamer1.0-alsa gstreamer1.0-fluendo-mp3 gstreamer1.0-libav fail2ban feh libkf5networkmanagerqt6 smartmontools tlp dconf-cli mesa-utils libvdpau-va-gl1 gstreamer0.10-alsa avahi-utils'
...
PROTOBUF_SRC_DIR="$PROTOBUF_DIR/buildspace/protobuf-$PROTOBUF_VERSION"
...
QTZEROCONF_SRC_DIR="$QTZEROCONF_DIR/src-qtzeroconf-$QTZEROCONF_VERSION"
...
LIRIOSWAYLAND_SRC_DIR="$LIRIOSWAYLAND_DIR/src-lirioswayland-$LIRIOSWAYLAND_VERSION"

LIBQTXDG_VERSION="2.0.0"
LIBQTXDG_DIR=$CONFIG_DIR/libqtxdg
LIBQTXDG_TARGET="$LIBQTXDG_DIR/buildspace/"
LIBQTXDG_SRC_DIR="$LIBQTXDG_DIR/src-libqtxdg-$LIBQTXDG_VERSION"
