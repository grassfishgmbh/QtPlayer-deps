...
./configure -prefix /opt/Qt/$QT_VERSION/gcc_64 -opensource -release -nomake examples -nomake tests -confirm-license -journald -qt-zlib -qt-libpng -qt-libjpeg -qt-xcb -qt-pcre -gstreamer 1.0 -qt-harfbuzz -opengl $OPENGL_IMPLEMENTATION
make -j`nproc`
